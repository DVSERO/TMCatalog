...
namespace TMCatalog.Model.DBContext
{
  ...
  public class DBInitializer : CreateDatabaseIfNotExists<TMCatalogDB>
  {
    ...
    /// <summary>
    /// Adds the vehicle type articles.
    /// </summary>
    /// <param name="context">The context.</param>
    ...
    /// <summary>
    /// Adds the vehicle type products.
    /// </summary>
    /// <param name="context">The context.</param>
